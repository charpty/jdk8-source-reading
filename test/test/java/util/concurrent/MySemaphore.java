...
import test.java.util.concurrent.locks.MyAbstractQueuedSynchronizer;
...
public class MySemaphore implements java.io.Serializable {
    ...
    /** All mechanics via MyAbstractQueuedSynchronizer subclass */
    ...
    abstract static class Sync extends MyAbstractQueuedSynchronizer {
        ...
        final int nonfairTryAcquireShared(int acquires) {
            ...
            for (; ; ) {
                ...
                // 仅当两种情况下返回，1、明确没有资源了 2、获取到资源了
                // 小于0时表示明确没有资源了，返回小于0时AQS也会将尝试当前线程进行阻塞
    ...
    static final class FairSync extends Sync {
        ...
        protected int tryAcquireShared(int acquires) {
            for (; ; ) {
                // 公平竞争资源最重要的就是线程都严格按照等待队列FIFO来获取资源
