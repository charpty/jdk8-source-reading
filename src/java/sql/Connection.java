...
public interface Connection extends Wrapper, AutoCloseable {
     ...
     *
     * @param map
     *         the <code>java.util.Map</code> object to install
     ...
     *
     * @throws SQLException
     *         if an object that implements the <code>SQLXML</code> interface can not
     ...
     *
     * @throws SQLException
     *         if the value supplied for <code>timeout</code>
     *         is less then 0
     ...
     *
     * @param typeName
     *         the SQL type name of the SQL structured type that this <code>Struct</code>
