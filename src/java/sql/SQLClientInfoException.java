...
public class SQLClientInfoException extends SQLException {
     ...
     *         defined in <code>ClientInfoStatus</code>
     * @param cause
     *         the (which is saved for later retrieval by the <code>getCause()</code> method); may be null indicating
     ...
     *         defined in <code>ClientInfoStatus</code>
     * @param cause
     *         the underlying reason for this <code>SQLException</code> (which is saved for later retrieval by the <code>getCause()</code> method); may be null indicating
     *         the cause is non-existent or unknown.
     *         <p>
     *
     * @since 1.6
