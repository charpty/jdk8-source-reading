...
public class BatchUpdateException extends SQLException {
     ...
     *         failure
     *
     * @see #BatchUpdateException(java.lang.String, java.lang.String, int, long[], * java.lang.Throwable)
     * @since 1.2
     */
     ...
     *         failure
     * @param cause
     *         the underlying reason for this <code>SQLException</code> (which is saved for later retrieval by the <code>getCause()</code> method);
