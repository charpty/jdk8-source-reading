...
public interface Clob {
     ...
     *
     * @param pos
     *         the position at which to start writing to the <code>CLOB</code>
     *         value that this <code>Clob</code> object represents;
     *         The first position is 1
     * @param str
     *         the string to be written to the <code>CLOB</code>
     ...
     *
     * @param len
     *         the length, in characters, to which the <code>CLOB</code> value
     *         should be truncated
     *
     * @throws SQLException
     *         if there is an error accessing the
