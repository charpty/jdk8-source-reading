...
public class Timestamp extends java.util.Date {
     ...
     *
     * @param s
     *         timestamp in format <code>yyyy-[m]m-[d]d hh:mm:ss[.f...]</code>.  The
     ...
     *
     * @param ts
     *         the <code>Timestamp</code> object to be compared to
     ...
     *
     * @param o
     *         the <code>Date</code> to be compared to
     *         this <code>Timestamp</code> object
     *
    ...
    public static Timestamp valueOf(LocalDateTime dateTime) {
        return new Timestamp(dateTime.getYear() - 1900, dateTime.getMonthValue() - 1, dateTime.getDayOfMonth(), dateTime.getHour(), dateTime.getMinute(),
