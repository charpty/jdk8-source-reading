...
public interface ResultSet extends Wrapper, AutoCloseable {
     ...
     *
     * @throws SQLException
     *         if the <code>ResultSet</code> object
     ...
     *
     * @param rows
     *         an <code>int</code> specifying the number of rows to
     ...
     *
     * @param direction
     *         an <code>int</code> specifying the suggested
     ...
     * @param scaleOrLength
     *         for an object of {@code java.math.BigDecimal} ,
     *         this is the number of digits after the decimal point. For
