...
public class PropertyDescriptor extends FeatureDescriptor {
    ...
    PropertyDescriptor(PropertyDescriptor x, PropertyDescriptor y) {
        ...
        if (xr != null && yr != null && xr.getDeclaringClass() == yr.getDeclaringClass() && getReturnType(getClass0(), xr) == boolean.class
                && getReturnType(getClass0(), yr) == boolean.class && xr.getName().indexOf(Introspector.IS_PREFIX) == 0
