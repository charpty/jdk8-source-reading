...
public abstract class URLConnection {
     ...
     *
     * @param timeout
     *         an {@code int} that specifies the connect
     ...
     *
     * @param timeout
     *         an {@code int} that specifies the timeout
     ...
     *
     * @param usecaches
     *         a {@code boolean} indicating whether
    ...
    static public String guessContentTypeFromStream(InputStream is) throws IOException {
        ...
        if (c1 == '<') {
            if (c2 == '!' || ((c2 == 'h' && (c3 == 't' && c4 == 'm' && c5 == 'l' || c3 == 'e' && c4 == 'a' && c5 == 'd') || (c2 == 'b' && c3 == 'o' && c4 == 'd'
                    && c5 == 'y'))) || ((c2 == 'H' && (c3 == 'T' && c4 == 'M' && c5 == 'L' || c3 == 'E' && c4 == 'A' && c5 == 'D') || (c2 == 'B' && c3 == 'O'
                    && c4 == 'D' && c5 == 'Y')))) {
                return "text/html";
            }
    ...
    static private boolean checkfpx(InputStream is) throws IOException {
        ...
        // intel byte order
        if (byteOrder == 0xFE && c[0] == 0x00 && c[2] == 0x61 && c[3] == 0x56 && c[4] == 0x54 && c[5] == 0xC1 && c[6] == 0xCE && c[7] == 0x11 && c[8] == 0x85
                && c[9] == 0x53 && c[10] == 0x00 && c[11] == 0xAA && c[12] == 0x00 && c[13] == 0xA1 && c[14] == 0xF9 && c[15] == 0x5B) {
            is.reset();
            return true;
        }

        // non-intel byte order
        else if (c[3] == 0x00 && c[1] == 0x61 && c[0] == 0x56 && c[5] == 0x54 && c[4] == 0xC1 && c[7] == 0xCE && c[6] == 0x11 && c[8] == 0x85 && c[9] == 0x53
                && c[10] == 0x00 && c[11] == 0xAA && c[12] == 0x00 && c[13] == 0xA1 && c[14] == 0xF9 && c[15] == 0x5B) {
            is.reset();
            return true;
        }
        is.reset();
