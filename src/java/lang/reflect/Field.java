...
public final class Field extends AccessibleObject implements Member {
     ...
     *
     * @param obj
     *         the object to extract the {@code boolean} value
     *         from
     *
     ...
     *
     * @param obj
     *         the object to extract the {@code byte} value
     *         from
     *
     ...
     *
     * @param obj
     *         the object to extract the {@code char} value
     *         from
     *
     ...
     *
     * @param obj
     *         the object to extract the {@code short} value
     *         from
     *
     ...
     *
     * @param obj
     *         the object to extract the {@code int} value
     *         from
     *
     ...
     *
     * @param obj
     *         the object to extract the {@code long} value
     *         from
     *
     ...
     *
     * @param obj
     *         the object to extract the {@code float} value
     *         from
     *
     ...
     *
     * @param obj
     *         the object to extract the {@code double} value
     *         from
     *
        ...
        if (declaredAnnotations == null) {
            ...
            if (root != null) {
                ...
                declaredAnnotations = AnnotationParser
                        .parseAnnotations(annotations, sun.misc.SharedSecrets.getJavaLangAccess().getConstantPool(getDeclaringClass()), getDeclaringClass());
            }
        }
    ...
    public AnnotatedType getAnnotatedType() {
        return TypeAnnotationParser.buildAnnotatedType(getTypeAnnotationBytes0(), sun.misc.SharedSecrets.getJavaLangAccess().
