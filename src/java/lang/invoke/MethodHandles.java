...
public class MethodHandles {
     ...
     *
     * @param <T>
     *         the desired type of the result, either {@link Member} or a subtype
     * @param target
     ...
     *         if the caller is not privileged to call {@code setAccessible}
    ...
    public static final class Lookup {
         ...
         *         the type of the method, with the receiver argument omitted
         * @param specialCaller
         *         the proposed calling class to perform the {@code invokespecial}
         *
         * @return the desired method handle
         *
         * @throws NoSuchMethodException
         ...
         * @throws IllegalAccessException
         *         if access checking fails, or if the field is {@code static}
         * @throws SecurityException
         *         if a security manager is present and it
         *         <a href="MethodHandles.Lookup.html#secmgr">refuses access</a>
         * @throws NullPointerException
         ...
         *         if the field does not exist
         * @throws IllegalAccessException
         *         if access checking fails, or if the field is not {@code static}
         * @throws SecurityException
         *         if a security manager is present and it
         *         <a href="MethodHandles.Lookup.html#secmgr">refuses access</a>
         * @throws NullPointerException
        ...
        void checkAccess(byte refKind, Class<?> refc, MemberName m) throws IllegalAccessException {
            assert (m.referenceKindIsConsistentWith(refKind) && MethodHandleNatives.refKindIsValid(refKind) && (MethodHandleNatives.refKindIsField(refKind) == m
                    .isField()));
            ...
            if (Modifier.isProtected(mods) && refKind == REF_invokeVirtual && m.getDeclaringClass() == Object.class && m.getName().equals("clone") && refc
                    .isArray()) {
        ...
        String accessFailedMessage(Class<?> refc, MemberName m) {
            ...
            if (!classOK && (allowedModes & PACKAGE) != 0) {
                classOK = (VerifyAccess.isClassAccessible(defc, lookupClass(), ALL_MODES) && (defc == refc || VerifyAccess
                        .isClassAccessible(refc, lookupClass(), ALL_MODES)));
            }
            if (!classOK) {
        ...
        private void checkSpecialCaller(Class<?> specialCaller) throws IllegalAccessException {
            ...
            if (!hasPrivateAccess() || (specialCaller != lookupClass() && !(ALLOW_NESTMATE_ACCESS && VerifyAccess
                    .isSamePackageMember(specialCaller, lookupClass())))) {
        ...
        private boolean restrictProtectedReceiver(MemberName method) {
            ...
            if (!method.isProtected() || method.isStatic() || allowedModes == TRUSTED || method.getDeclaringClass() == lookupClass() || VerifyAccess
                    .isSamePackage(method.getDeclaringClass(), lookupClass()) || (ALLOW_NESTMATE_ACCESS && VerifyAccess
        ...
        private MethodHandle getDirectMethodNoSecurityManager(byte refKind, Class<?> refc, MemberName method, Class<?> callerClass)
                throws IllegalAccessException {
            final boolean doRestrict = true;
        ...
        private MethodHandle getDirectMethodCommon(byte refKind, Class<?> refc, MemberName method, boolean checkSecurity, boolean doRestrict,
            ...
            if (refKind == REF_invokeSpecial && refc != lookupClass() && !refc.isInterface() && refc != lookupClass().getSuperclass() && refc
        ...
        private boolean canBeCached(byte refKind, Class<?> defc, MemberName member) {
            ...
            if (!Modifier.isPublic(defc.getModifiers()) || !Modifier.isPublic(member.getDeclaringClass().getModifiers()) || !member.isPublic() || member
                    .isCallerSensitive()) {
                return false;
            }
     ...
     * @throws IllegalArgumentException
     *         if {@code leadingArgCount} is not in
     ...
     *         if either argument is null
     * @throws IllegalArgumentException
     *         if the return type of {@code filter}
     ...
     *         if either argument is null
     * @throws IllegalArgumentException
     *         if {@code combiner}'s return type
     ...
     *         if any argument is null
     * @throws IllegalArgumentException
     *         if {@code handler} does not accept
