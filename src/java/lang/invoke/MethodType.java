...
public final class MethodType implements java.io.Serializable {
     ...
     *         if {@code rtype} or {@code ptypes} or any element of {@code ptypes} is null
     ...
     *
     * @throws NullPointerException
     *         if {@code rtype} or {@code ptype0} or {@code ptypes} or any element of {@code ptypes} is null
     * @throws IllegalArgumentException
     *         if {@code ptype0} or {@code ptypes} or any element of {@code ptypes} is {@code void.class}
     */
     ...
     *
     * @throws IllegalArgumentException
     *         if {@code objectArgCount} is negative or greater than 255 (or 254, if {@code finalArray} is true)
     ...
     *         if {@code num} is not a valid index into {@code parameterArray()}
     * @throws IllegalArgumentException
     ...
     *
     * @throws IndexOutOfBoundsException
     *         if {@code num} is negative or greater than {@code parameterCount()}
     * @throws IllegalArgumentException
     *         if any element of {@code ptypesToInsert} is {@code void.class}
     ...
     *
     * @param start
     *         the position (zero-based) of the first replaced parameter type(s)
     * @param end
     *         the position (zero-based) after the last replaced parameter type(s)
     * @param ptypesToInsert
     *         zero or more new parameter types to insert into the parameter list
     *
     ...
     *
     * @throws IndexOutOfBoundsException
     *         if {@code start} is negative or greater than {@code parameterCount()}
     ...
     * @param end
     *         the index (greater than {@code start}) of the first parameter type after not to remove
     *
    ...
    boolean isConvertibleTo(MethodType newType) {
        ...
        if ((oldForm.primitiveParameterCount() == 0 && oldForm.erasedType == this) || (newForm.primitiveParameterCount() == 0
