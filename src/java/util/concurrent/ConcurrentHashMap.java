 ...
 *
 * 该类是哈希表的一个并发版本，完全支持并发的读，并且可以做到相对HashTable来说更高效的写。
 * 该实现功能是和HashTable一致的。不同的是，在并发更新场景下并不是每次都加锁，任何场景下也不会锁住整个哈希表。
 * 该类和HashTable在调用者不依赖同步细节（可见性影响等）的情况下是可以等价交换的。
 *
 ...
 * for program control.
 *
 * 访问型操作（比如get）一般来说是不会阻塞的，所以会和修改型操作同时执行。
...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
	...
	static class Node<K, V> implements Map.Entry<K, V> {
		...
		public final boolean equals(Object o) {
			Object k, v, u;
			Map.Entry<?, ?> e;
			return ((o instanceof Map.Entry) && (k = (e = (Map.Entry<?, ?>) o).getKey()) != null && (v = e.getValue()) != null && (k == key || k.equals(key))
					&& (v == (u = val) || v.equals(u)));
		}
	...
	private final void addCount(long x, int check) {
		...
		if ((as = counterCells) != null || !U.compareAndSwapLong(this, BASECOUNT, b = baseCount, s = b + x)) {
			...
			if (as == null || (m = as.length - 1) < 0 || (a = as[ThreadLocalRandom.getProbe() & m]) == null || !(uncontended = U
			...
			for (TreeNode<K, V> p = root; ; ) {
				...
				if (p == null) {
					...
					if (!searched) {
						TreeNode<K, V> q, ch;
						searched = true;
						if (((ch = p.left) != null && (q = ch.findTreeNode(h, k, kc)) != null) || ((ch = p.right) != null
	...
	static final class EntrySetView<K, V> extends CollectionView<K, V, Map.Entry<K, V>> implements Set<Map.Entry<K, V>>, java.io.Serializable {
		...
		public boolean contains(Object o) {
			Object k, v, r;
			Map.Entry<?, ?> e;
			return ((o instanceof Map.Entry) && (k = (e = (Map.Entry<?, ?>) o).getKey()) != null && (r = map.get(k)) != null && (v = e.getValue()) != null && (
					v == r || v.equals(r)));
		}
	...
	static final class ForEachTransformedMappingTask<K, V, U> extends BulkTask<K, V, Void> {
		...
		ForEachTransformedMappingTask(BulkTask<K, V, ?> p, int b, int i, int f, Node<K, V>[] t, BiFunction<? super K, ? super V, ? extends U> transformer,
				Consumer<? super U> action) {
			super(p, b, i, f, t);
			this.transformer = transformer;
			this.action = action;
