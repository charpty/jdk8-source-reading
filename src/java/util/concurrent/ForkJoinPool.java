...
public class ForkJoinPool extends AbstractExecutorService {
     ...
     *
     * @param c
     *         incoming ctl value, with total count negative and no
     ...
     *
     * @param now
     *         if true, unconditionally terminate, else only
    ...
    final void externalPush(ForkJoinTask<?> task) {
        ...
        int rs = runState;
        if ((ws = workQueues) != null && (m = (ws.length - 1)) >= 0 && (q = ws[m & r & SQMASK]) != null && r != 0 && rs > 0 && U
