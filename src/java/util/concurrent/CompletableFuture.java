...
public class CompletableFuture<T> implements Future<T>, CompletionStage<T> {
    ...
    public String toString() {
        ...
        return super.toString() + ((r == null) ?
                (((count = getNumberOfDependents()) == 0) ? "[Not completed]" : "[Not completed, " + count + " dependents]") :
                (((r instanceof AltResult) && ((AltResult) r).ex != null) ? "[Completed exceptionally]" : "[Completed normally]"));
    }
